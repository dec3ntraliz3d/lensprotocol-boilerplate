...
export type LatestDataStruct = {
  profileStruct: DataTypes.ProfileStructStruct;
  publicationStruct: DataTypes.PublicationStructStruct;
};
...
export type LatestDataStructOutput = [
  ...
  profileStruct: DataTypes.ProfileStructStructOutput;
  publicationStruct: DataTypes.PublicationStructStructOutput;
};
